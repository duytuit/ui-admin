  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" label-width="80px">
      <el-row>
        ...
        <el-col :span="8" :offset="2">
          <el-form-item label="Đăng nhập tài khoản" prop="userName">
    ...
    <el-table v-loading="loading" :row-key="getRowKey" @row-click="clickRow" ref="table" @selection-change="handleSelectionChange" :data="roles.slice((pageNum-1)*pageSize,pageNum*pageSize)">
      ...
      <el-table-column label="Số ký tự" align="center" prop="roleId" />
      <el-table-column label="Tên vai" align="center" prop="roleName" />
      <el-table-column label="Nhân vật cho phép" align="center" prop="roleKey" />
  ...
  methods: {
    ...
    submitForm() {
      ...
      updateAuthRole({ userId: userId, roleIds: roleIds }).then((response) => {
        this.$modal.msgSuccess("Ủy quyền thành công");
        this.close();
      });
    },
    /** Đóng nút */
